    ...
    if (isset($_POST['signup'])) {
        ...
        if (count($errors) === 0) {
            ...
            if ($insertInfo) {
                ...
                $subject = 'Utispo OTP Verification';
                $message = "Verification code is $code.\n Welcome to UTISPO!\n
We are thrilled to have you as a new member of our community. Our team is dedicated to providing you with the best experience possible, and we are excited to have the opportunity to work with you. As a new user, you will have access to a variety of features on our platform. If you have any questions or issues, please don't hesitate to reach out to our support team at service@utispo.com. We are always happy to help.
Thank you for choosing UTISPO. We look forward to working with you!\n
Best regards,
UTISPO Team";
